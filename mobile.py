...
while True:
    ...
    if c == 'c':
        ...
        if dtn is None:
            print 'start'
            dtn = MobileSiteManager(dtn_port=25555, bcast_port=26666, ip=ip, db_name='mobile')
            dtn.start()
    #DEMO
    elif c == '1':
        if dtn is None:
            print 'start'
            dtn = MobileSiteManager(dtn_port=25555, bcast_port=26666, ip=ip, db_name='mobile', sh='mobile')
            dtn.start()
    elif c == '2':
        if dtn is None:
            print 'start'
